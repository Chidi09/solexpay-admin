  ...
  template: `
    <footer class="bg-inverse-surface text-surface py-20">
      <div class="max-w-7xl mx-auto px-6">
        <div
          class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 md:gap-12 mb-12 md:mb-16"
        >
          <!-- Brand -->
          <div class="sm:col-span-2 space-y-5">
            <div class="flex items-center gap-1">
              <img
                src="/logo-icon.png"
                alt="Solexpay"
                class="h-10 w-auto shrink-0 object-contain brightness-0 invert"
              />
              <span
                class="text-2xl font-black tracking-tighter text-white font-display"
                >Solexpay</span
              >
            </div>
            <p class="text-outline-variant text-sm leading-relaxed max-w-xs">
              Financial empowerment for the next generation of African leaders.
            ...
            <div class="space-y-1.5 text-sm">
              <a
                ...
                class="flex items-center gap-2 text-outline-variant hover:text-white transition-colors"
              >
                <svg
          ...
          <div>
            ...
            <ul class="space-y-3 text-outline-variant text-sm">
              <li
                class="hover:text-primary-fixed transition-colors cursor-pointer"
              >
                Smart Wallet
              </li>
              <li
          ...
          <div>
            ...
            <div class="space-y-3">
              ...
              <a
                href="#"
                class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 flex items-center gap-3 hover:bg-white/10 cursor-pointer transition-colors"
              >
                <svg
        ...
        <div
          class="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-outline-variant text-xs"
        >
          <p>© 2026 SolexPay Technologies Ltd. All rights reserved.</p>
          <div class="flex gap-6">
            <a routerLink="/docs" class="hover:text-white transition-colors"
              >Developer API</a
            >

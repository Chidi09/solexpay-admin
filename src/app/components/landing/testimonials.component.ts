    ...
    <section class="py-24 bg-surface-container">
      <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16" data-aos="fade-up">
          <p
            class="text-on-surface-variant font-bold text-sm tracking-widest uppercase mb-8"
          >
            Trusted Across Nigeria
          </p>
          <div
            class="flex flex-wrap justify-center items-center gap-4 md:gap-5 mb-16"
          >
            @for (uni of universities; track uni.name; let i = $index) {
              ...
              >
                ...
                />
                <span class="text-sm font-bold text-on-surface tracking-wide">{{
                  uni.name
                }}</span>
              </div>
            }
        ...
        <div class="grid md:grid-cols-3 gap-6">
          @for (review of testimonials; track review.name; let i = $index) {
            ...
            >
              ...
              <p class="text-on-surface mb-6 leading-relaxed italic">
                "{{ review.quote }}"
              </p>
              <div class="flex items-center gap-3">
                ...
                />
                <div>
                  <p class="font-bold text-sm text-on-surface font-display">
                    {{ review.name }}
                  </p>
                  <p
  ...
  readonly testimonials: Testimonial[] = [
    {
      ...
      quote:
        "SolexPay saved me when my hostel rent was due and my allowance was delayed. The student loan was fast and very easy to pay back.",
      avatar:
        "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=200&h=200&fit=crop&crop=faces&auto=format&q=80",
    },
    {
      name: "Tunde J.",
      school: "OAU Student",
      quote:
        "Finally an app that understands student life. I use target savings to keep money aside for my final year project. Very reliable!",
      avatar:
        "https://images.unsplash.com/photo-1531384441138-2736e62e0919?w=200&h=200&fit=crop&crop=faces&auto=format&q=80",
    },
    {
      name: "Fatima S.",
      school: "ABU Student",
      quote:
        "Instant transfers to classmates and the student data deals are unbeatable. Every Nigerian student needs SolexPay.",
      avatar:
        "https://images.unsplash.com/photo-1619895862022-09114b41f16f?w=200&h=200&fit=crop&crop=faces&auto=format&q=80",
    },
  ];
}

...
@Component({
  ...
  template: `
    <nav
      class="fixed top-0 w-full z-50 border-b border-outline-variant/20 shadow-sm"
    >
      <div
      ...
      >
        <div class="flex items-center gap-8">
          <div class="flex items-center gap-1">
            ...
            />
            <span
              class="text-xl font-black tracking-tighter text-primary font-display"
              >Solexpay</span
            >
          </div>
        ...
        <div class="flex items-center gap-3">
          <a
            routerLink="/login"
            class="hidden sm:flex px-5 py-2 text-sm font-semibold text-on-surface-variant hover:text-primary transition-colors items-center gap-2"
          >

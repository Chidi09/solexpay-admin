...
@Component({
  ...
  styles: [
    `
      ...
      .phone-glow {
        box-shadow:
          0 50px 100px -20px rgba(0, 91, 191, 0.35),
          0 20px 40px -10px rgba(0, 91, 191, 0.2);
      }
      .phone-back {
        box-shadow:
          0 40px 80px -20px rgba(0, 109, 44, 0.25),
  ...
  template: `
    <section
      class="max-w-7xl mx-auto px-4 sm:px-6 pt-28 sm:pt-32 pb-16 sm:pb-20 md:pb-28 grid md:grid-cols-2 gap-8 md:gap-12 items-center"
    >
      <!-- Left copy -->
      <div
      ...
      >
        <div
          class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-secondary-fixed text-on-secondary-fixed-variant text-xs font-bold tracking-widest uppercase"
        >
          <lucide-icon
        ...
        <h1
          class="text-4xl sm:text-5xl md:text-[4.25rem] font-extrabold tracking-tighter leading-[1.05] text-on-surface font-display"
        >
          The smarter<br />wallet for<br /><span class="text-primary"
            >campus life.</span
          >
        </h1>

        <p
          class="text-base sm:text-lg text-on-surface-variant max-w-md leading-relaxed"
        >
          Manage allowances, pay school fees, and access instant student loans —
        ...
        <div class="pt-2">
          <p
            class="text-xs text-on-surface-variant mb-3 font-medium uppercase tracking-wider"
          >
            Available on
          </p>
          <div class="flex flex-wrap gap-3">
            ...
            >
              ...
              <div class="text-left">
                <p class="text-[10px] opacity-70 leading-none mb-0.5">
                  Download on the
                </p>
        ...
        <div class="pt-4">
          <p
            class="text-[11px] text-on-surface-variant mb-3 font-bold uppercase tracking-[0.18em]"
          >
            Built on trusted Nigerian rails
          </p>
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
            <div
              class="bg-surface-container-low rounded-xl px-3 py-2.5 border border-outline-variant/20 flex flex-col items-center gap-1.5"
            >
              <img
                src="/trust/cbn.png"
              ...
              />
              <span
                class="text-[10px] font-bold text-on-surface-variant tracking-wide"
                >CBN Standards</span
              >
            </div>
            <div
      ...
      <!-- Right phone mockups -->
      <div
        class="relative flex justify-center items-center min-h-[420px] sm:min-h-[520px] md:min-h-[620px]"
        data-aos="fade-left"
        data-aos-duration="800"
        data-aos-delay="150"
      >
        <div
          class="absolute top-0 right-0 w-80 h-80 bg-primary/10 rounded-full blur-3xl pointer-events-none"
        ></div>
        <div
          class="absolute bottom-0 left-0 w-64 h-64 bg-tertiary/10 rounded-full blur-3xl pointer-events-none"
        ></div>

        <!-- Back phone — hidden on mobile -->
        <div
          class="absolute left-0 top-10 z-10 hidden sm:block w-[210px] phone-frame-green rounded-[2.75rem] p-[6px] phone-back animate-float-delayed"
        >
          <div class="bg-slate-950 rounded-[2.55rem] p-1 h-full">
            <div class="bg-surface rounded-[2.3rem] overflow-hidden h-full">
              <div
                class="h-6 bg-slate-950 flex items-center justify-center rounded-t-[2.3rem]"
              >
                <div class="w-16 h-4 bg-black rounded-full"></div>
              </div>
              <div class="p-4 flex flex-col gap-3 h-[calc(100%-1.5rem)]">
                <div
                  class="bg-tertiary-container p-4 rounded-2xl text-on-tertiary-container"
                >
                  <p class="text-[10px] font-bold opacity-80 mb-1">
                    Loan Approved
                  </p>
                ...
                <div class="flex-1 flex flex-col gap-2 min-h-0">
                  <div
                    class="flex-1 bg-surface-container-low px-3 rounded-xl flex justify-between items-center"
                  >
                    <span
                ...
                <div
                  class="w-full py-2.5 bg-tertiary text-on-tertiary text-[11px] font-bold rounded-xl text-center"
                >
                  View Schedule
                </div>
              </div>
        ...
        <!-- Front phone -->
        <div
          class="relative z-20 sm:ml-20 w-[210px] sm:w-[260px] phone-frame rounded-[3.25rem] p-[6px] sm:p-[7px] phone-glow animate-float"
        >
          <div
              ...
              <div class="px-4 pt-10 pb-4 flex flex-col gap-3 h-full">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="relative">
                    <lucide-icon
                      [img]="BellIcon"
                      class="w-4.5 h-4.5 text-outline"
                    ></lucide-icon>
                    <span
                ...
                <div
                  class="editorial-gradient px-4 py-4 rounded-2xl text-on-primary shadow-lg"
                >
                  ...
                  <p class="text-[8px] opacity-65 mt-0.5">
                    **** 4521 · Verified
                  </p>
                </div>
                ...
                <div class="grid grid-cols-4 gap-2">
                  @for (action of quickActions; track action.label) {
                    <div
                      class="bg-surface-container rounded-xl py-2.5 flex flex-col items-center gap-1"
                    >
                      <div
                      ...
                      <p
                        class="text-[8px] font-bold text-on-surface-variant leading-none"
                      >
                        {{ action.label }}
                      </p>
                    </div>
                ...
                <div>
                  <p
                    class="text-[9px] font-bold text-on-surface-variant uppercase tracking-wider mb-2"
                  >
                    Recent Activity
                  </p>
                  <div class="space-y-2">
                    <div
                      class="flex justify-between items-center bg-surface-container-low p-2.5 rounded-xl"
                    >
                      <div class="flex items-center gap-2">
                        <div
                          class="w-8 h-8 bg-primary-fixed rounded-lg flex items-center justify-center"
                        >
                          <lucide-icon
                            [img]="UtensilsIcon"
                            class="w-3.5 h-3.5 text-primary"
                    ...
                    >
                      <div class="flex items-center gap-2">
                        <div
                          class="w-8 h-8 bg-tertiary/10 rounded-lg flex items-center justify-center"
                        >
                          <lucide-icon
                            [img]="PiggyBankIcon"
        ...
        <div
          class="absolute top-4 right-4 z-30 glass-card rounded-2xl px-4 py-3 shadow-lg border border-white/60 flex items-center gap-3 animate-float-delayed"
        >
          <div
            class="w-8 h-8 bg-tertiary rounded-full flex items-center justify-center"
          >
            <lucide-icon
              [img]="CheckIcon"
              class="w-4 h-4 text-on-tertiary"
            ></lucide-icon>
          </div>
          <div>
        ...
        <div
          class="absolute bottom-6 right-2 z-30 glass-card rounded-2xl px-4 py-3 shadow-lg border border-white/60 flex items-center gap-3 animate-float"
        >
          <div
            class="w-8 h-8 editorial-gradient rounded-full flex items-center justify-center"
          >
            <lucide-icon
              [img]="ZapIcon"
              class="w-4 h-4 text-on-primary"
            ></lucide-icon>
          </div>
          <div>

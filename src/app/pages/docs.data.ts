    ...
    endpoints: [
      {
        ...
        description:
          "Sends a 6-digit OTP to the provided phone number as the first step of user registration.",
        auth: "None",
      ...
      },
      {
        ...
        description:
          "Completes user registration. Requires a valid OTP obtained from POST /auth/otp/registration.",
        auth: "None",
      ...
      },
      {
        ...
        description:
          "Triggers OTP for first-time PIN setup after registration.",
        auth: "None",
        responses: [{ status: 200, description: "OTP sent" }],
      },
      {
        id: "auth-pin-set",
        method: "POST",
        ...
        description:
          "Sets a 4-digit transaction PIN. Requires OTP verification.",
        auth: "None",
        requestBody: JSON.stringify(
          {
            phoneNumber: "08012345678",
          ...
          .replace(/{/g, "&#123;")
          .replace(/}/g, "&#125;"),
        responses: [{ status: 200, description: "PIN set successfully" }],
      },
      {
        id: "auth-pin-change",
        method: "POST",
        ...
        description:
          "Changes an existing transaction PIN. All three fields are required and must be 4 digits.",
        auth: "Bearer Token",
        requestBody: JSON.stringify(
          {
            oldPin: "1234",
          ...
          .replace(/{/g, "&#123;")
          .replace(/}/g, "&#125;"),
        responses: [{ status: 200, description: "PIN changed successfully" }],
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        description:
          "Updates user profile. All fields are optional — only include fields to change.",
        auth: "Bearer Token",
        requestBody: JSON.stringify(
          {
            firstName: "Chidi",
    ...
    endpoints: [
      ...
      },
      {
        ...
        requestBody: JSON.stringify(
          ...
          .replace(/{/g, "&#123;")
          .replace(/}/g, "&#125;"),
        responses: [{ status: 200, description: "Wallet funded successfully" }],
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        ...
        summary: "Verify BVN",
        description:
          "Submits BVN for Tier 2 verification. Pattern: ^[0-9]&#123;11&#125;$",
        auth: "Bearer Token",
        requestBody: JSON.stringify({ bvn: "12345678901" }, null, 2)
          .replace(/{/g, "&#123;")
          .replace(/}/g, "&#125;"),
        responses: [{ status: 200, description: "Verification submitted" }],
      },
      {
        id: "kyc-nin",
        method: "POST",
      ...
      },
      {
        ...
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Status retrieved" }],
      },
      {
        id: "kyc-check",
        method: "GET",
        ...
        description:
          "Quick boolean check — has the current user completed KYC?",
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Result: true/false" }],
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        ...
        description:
          "Verifies an external bank account and retrieves the account holder name.",
        auth: "Bearer Token",
        requestBody: JSON.stringify(
          ...
          .replace(/{/g, "&#123;")
          .replace(/}/g, "&#125;"),
        responses: [{ status: 200, description: "Account found" }],
      },
      {
        id: "nip-fee",
        method: "POST",
        ...
        description:
          "Returns the fee and total deduction for a given transfer amount.",
        auth: "Bearer Token",
        requestBody: JSON.stringify({ amount: 50000 }, null, 2)
          .replace(/{/g, "&#123;")
          .replace(/}/g, "&#125;"),
        responses: [{ status: 200, description: "Fee calculated" }],
      },
      {
        id: "nip-init",
        method: "POST",
        ...
        requestBody: JSON.stringify(
          ...
          .replace(/{/g, "&#123;")
          .replace(/}/g, "&#125;"),
        responses: [{ status: 200, description: "Transfer initiated" }],
      },
      {
        id: "nip-banks",
        method: "GET",
        ...
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Banks retrieved" }],
      },
      {
        id: "nip-details",
        method: "GET",
        ...
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Details retrieved" }],
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        requestBody: JSON.stringify(
          ...
          .replace(/{/g, "&#123;")
          .replace(/}/g, "&#125;"),
        responses: [{ status: 200, description: "Transfer completed" }],
      },
      {
        id: "p2p-history",
        method: "GET",
        ...
        auth: "Bearer Token",
        responses: [{ status: 200, description: "History retrieved" }],
      },
      {
        id: "p2p-details",
        method: "GET",
    ...
    endpoints: [
      {
        ...
        description:
          "Returns paginated transaction history using cursor-based pagination.",
        auth: "Bearer Token",
        queryParams: [
          {
            name: "cursor",
        ...
        responses: [{ status: 200, description: "List retrieved" }],
      },
      {
        id: "txn-details",
        method: "GET",
      ...
      },
      {
        ...
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Entries retrieved" }],
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        ...
        requestBody: JSON.stringify(
          ...
          .replace(/{/g, "&#123;")
          .replace(/}/g, "&#125;"),
        responses: [{ status: 200, description: "Application submitted" }],
      },
      {
        id: "loan-my",
        method: "GET",
        ...
        summary: "My Loans",
        description:
          "Returns all loan applications for the currently authenticated student.",
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Loans retrieved" }],
      },
      {
        id: "loan-id",
        method: "GET",
        ...
        description:
          "Single loan application response with all status timestamps.",
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Details retrieved" }],
      },
      {
        ...
        description:
          "Returns the installment-by-installment repayment schedule for an active loan.",
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Schedule retrieved" }],
      },
      {
        id: "loan-accept",
        method: "POST",
        ...
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Offer accepted" }],
      },
      {
        id: "loan-cancel",
        method: "POST",
        ...
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Loan cancelled" }],
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        ...
        description:
          "Returns the structured repayment schedule as InstallmentDto objects.",
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Schedule retrieved" }],
      },
      {
        ...
        description:
          "Retrieves current outstanding principal, interest and next installment details.",
        auth: "Bearer Token",
        responses: [
          {
            status: 200,
            ...
            body: JSON.stringify(
              {
                ...
                data: {
                  loanId: "uuid",
                  totalOutstanding: 103500.0,
                  nextDueDate: "2026-05-28",
                  nextInstallmentAmount: 28750.0,
                },
              },
              null,
              2,
      ...
      },
      {
        ...
        auth: "Bearer Token",
        requestBody: JSON.stringify(
          { amount: 28750, idempotencyKey: "rep-001" },
          null,
          2,
        )
          .replace(/{/g, "&#123;")
          .replace(/}/g, "&#125;"),
        responses: [{ status: 200, description: "Repayment successful" }],
      },
      {
        id: "repay-preview",
        method: "POST",
        ...
        description:
          "Generates a full amortization table for a hypothetical loan.",
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Preview generated" }],
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        ...
        description:
          "Creates a new regular, target or emergency savings account.",
        auth: "Bearer Token",
      ...
      },
      {
        ...
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Accounts retrieved" }],
      },
      {
        id: "sav-id",
        method: "GET",
        ...
        description:
          "Retrieves current balance and accrued interest for a savings account.",
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Details retrieved" }],
      },
      {
        ...
        description:
          "Moves funds from the user's wallet into a savings account.",
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Deposit successful" }],
      },
      {
        id: "sav-with",
        method: "POST",
        ...
        description:
          "Moves funds from a savings account back to the user's wallet.",
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Withdrawal successful" }],
      },
      {
        id: "sav-close",
        method: "POST",
        ...
        description:
          "Closes a savings account. Any remaining balance is moved to the user's wallet.",
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Account closed" }],
      },
      {
        id: "sav-int",
        method: "GET",
    ...
    endpoints: [
      {
        ...
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Purchase successful" }],
      },
      {
        id: "bill-data",
        method: "POST",
      ...
      },
      {
        ...
        description:
          "Queries the live status of a bill payment from the provider.",
        auth: "Bearer Token",
      ...
      },
      {
        ...
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Receipt retrieved" }],
      },
      {
        id: "bill-history",
        method: "GET",
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        auth: "Bearer Token",
        responses: [{ status: 200, description: "Count: 7" }],
      },
      {
        id: "notif-read",
        method: "POST",
    ...
    endpoints: [
      {
        ...
        description:
          "Retrieves total users, transaction volume, and loan portfolio KPIs.",
        auth: "Admin Only",
        responses: [{ status: 200, description: "Metrics retrieved" }],
      },
      {
        id: "admin-users",
        method: "GET",
        ...
        auth: "Admin Only",
        responses: [{ status: 200, description: "Users list" }],
      },
      {
        id: "admin-txns",
        method: "GET",
        ...
        auth: "Admin Only",
        responses: [{ status: 200, description: "Transactions list" }],
      },
      {
        id: "admin-loans",
        method: "GET",
        ...
        auth: "Admin Only",
        responses: [{ status: 200, description: "Loans list" }],
      },
      {
        id: "admin-overdue",
        method: "GET",
        ...
        auth: "Admin Only",
        responses: [{ status: 200, description: "Overdue list" }],
      },
      {
        id: "admin-suspend",
        method: "POST",
      ...
      },
      {
        ...
        auth: "Admin Only",
        responses: [{ status: 200, description: "User reactivated" }],
      },
      {
        id: "admin-kyc-app",
        method: "POST",
      ...
      },
      {
        ...
        auth: "Admin Only",
        responses: [{ status: 200, description: "Broadcast sent" }],
      },
    ],
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        auth: "School Only",
        responses: [{ status: 200, description: "Students list" }],
      },
      {
      ...
      },
      {
        ...
        auth: "School Only",
        responses: [{ status: 200, description: "Verified" }],
      },
      {
        id: "loan-school-ver",
        method: "POST",
      ...
      },
      {
        ...
        auth: "School Only",
        responses: [{ status: 200, description: "Rejected" }],
      },
      {
        id: "loan-school-pend",
        method: "GET",
    ...
    endpoints: [
      {
        ...
        auth: "Admin Only",
        responses: [{ status: 200, description: "Queue retrieved" }],
      },
      {
        id: "ops-approve",
        method: "POST",
    ...
    endpoints: [
      {
        ...
        auth: "None",
        responses: [{ status: 200, description: "Event received" }],
      },
      {
        id: "webhook-kyc",
        method: "POST",

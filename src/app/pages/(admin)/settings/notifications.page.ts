...
@Component({
  ...
  template: `
    <div class="space-y-6">
      <h1 class="text-2xl font-bold text-on-surface">Notification Preferences</h1>
      
      <div class="bg-surface-container-lowest rounded-xl p-6 shadow-[0_2px_12px_rgba(25,28,29,0.06)]">
        <h2 class="text-lg font-bold text-on-surface mb-4">Email Notifications</h2>
        <div class="space-y-3">
          <label class="flex items-center justify-between p-3 bg-surface-container rounded-xl cursor-pointer hover:bg-surface-container-high transition-colors">
            <div>
            ...
            <input type="checkbox" checked class="w-5 h-5 rounded border-outline text-primary focus:ring-primary">
          </label>
          ...
          <label class="flex items-center justify-between p-3 bg-surface-container rounded-xl cursor-pointer hover:bg-surface-container-high transition-colors">
            ...
            <input type="checkbox" class="w-5 h-5 rounded border-outline text-primary focus:ring-primary">
          </label>
        </div>
      </div>

      <div class="bg-surface-container-lowest rounded-xl p-6 shadow-[0_2px_12px_rgba(25,28,29,0.06)]">
        <h2 class="text-lg font-bold text-on-surface mb-4">Push Notifications</h2>
        <div class="space-y-3">
          <label class="flex items-center justify-between p-3 bg-surface-container rounded-xl cursor-pointer hover:bg-surface-container-high transition-colors">
            <div>
      ...
      <button 
        ...
        class="px-6 py-2.5 bg-primary text-on-primary rounded-xl font-bold text-sm">
        Save Preferences
      </button>
    </div>
  `

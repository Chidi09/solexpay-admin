...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-surface">
      ...
      <!-- Hero Section -->
      <section
        class="pt-32 pb-12 bg-gradient-to-b from-secondary-fixed/30 to-surface"
      >
        <div class="max-w-4xl mx-auto px-6">
          ...
          <div class="space-y-4">
            <div
              class="inline-flex items-center gap-2 px-4 py-2 bg-secondary-container/20 rounded-full text-sm font-medium text-secondary"
            >
            ...
            >
              Solexpay respects your privacy and is committed to protecting your
              personal information. This Privacy Policy explains how we collect,
              use, store, and disclose your information.
            </p>
        ...
        <div class="max-w-4xl mx-auto px-6">
          ...
          >
            <div class="flex items-start gap-4">
              <div
                class="w-12 h-12 rounded-xl bg-secondary-container/30 flex items-center justify-center shrink-0"
              >
                <lucide-icon
                  [img]="ShieldIcon"
              ...
              <div class="space-y-3">
                ...
                <p class="text-on-surface-variant leading-relaxed">
                  Solexpay respects your privacy and is committed to protecting
                  your personal information. This Privacy Policy explains how we
                  collect, use, store, and disclose your information when you
                  use the Solexpay platform, including our mobile application,
                  website, and related services.
                </p>
                <p class="text-on-surface-variant leading-relaxed">
                  By using Solexpay, you agree to the collection and use of
                  information in accordance with this Policy.
                </p>
                <div
                  class="inline-flex items-center gap-2 px-4 py-2 bg-tertiary-container/20 rounded-lg text-sm text-tertiary"
                >
                  <lucide-icon [img]="ShieldIcon" class="w-4 h-4"></lucide-icon>
                  Solexpay is a financial technology platform and not a bank
                </div>
                <p class="text-sm text-on-surface-variant">
                  Some services may be provided through licensed partner
          ...
          <div class="space-y-12">
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                <p>
                  We collect information to provide secure wallet services,
                  transfers, and virtual card functionality. The types of
                  information we collect fall into four categories.
                </p>
                ...
                >
                  <div class="flex items-center gap-3">
                    <div
                      class="w-8 h-8 rounded-lg bg-primary-container/20 flex items-center justify-center"
                    >
                      <lucide-icon
                        [img]="UserIcon"
                  ...
                  <p class="text-sm">
                    Includes your full name, phone number, email address, date
                    of birth, residential address, profile photo,
                    government‑issued ID, and selfie verification.
                  </p>
                </div>
                ...
                >
                  ...
                  <p class="text-sm">
                    Includes your wallet balances, transaction history, payment
                    activity, transfer details, card usage data, and merchant
                    transactions.
                  </p>
                </div>
                ...
                >
                  ...
                  <p class="text-sm">
                    Includes your IP address, device type, operating system, app
                    version, browser type, device ID, and login activity.
                  </p>
                </div>
                ...
                >
                  <div class="flex items-center gap-3">
                    <div
                      class="w-8 h-8 rounded-lg bg-surface-container-high flex items-center justify-center"
                    >
                      <lucide-icon
                        [img]="ClockIcon"
                  ...
                  <p class="text-sm">
                    Includes app interaction data, features you use, session
                    activity, time spent on the platform, and navigation
                    patterns.
                  </p>
                </div>
              </div>
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                <p>
                  To comply with regulatory requirements, Solexpay may request:
                </p>
                ...
                <div
                  class="bg-secondary-fixed/50 rounded-lg p-4 border-l-4 border-secondary"
                >
                  <p class="text-sm">
                    We may restrict account functionality until verification is
                    completed.
                  </p>
                </div>
              </div>
            ...
            <div class="space-y-6">
              ...
              >
                <div
                  class="w-10 h-10 rounded-lg bg-error-container/50 flex items-center justify-center"
                >
                  <lucide-icon
                    [img]="Share2Icon"
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                ...
                <div class="space-y-3">
                  <h3
                    class="font-semibold text-on-surface flex items-center gap-2"
                  >
                    <div
                      class="w-6 h-6 rounded bg-primary-container/20 flex items-center justify-center"
                    >
                      <lucide-icon
                        [img]="DatabaseIcon"
                  ...
                  <p class="text-sm pl-8">
                    Licensed banks and card issuers that provide wallet
                    infrastructure, card issuance, and payment processing. When
                    we share data with a financial partner, their own privacy
                    policy also applies to that part of the service.
                  </p>
                </div>
                ...
                <div class="space-y-3">
                  ...
                  >
                    <div
                      class="w-6 h-6 rounded bg-secondary-container/20 flex items-center justify-center"
                    >
                      <lucide-icon
                        [img]="ShieldIcon"
                  ...
                  <p class="text-sm pl-8">
                    Third‑party services used for identity verification, fraud
                    prevention, and compliance screening.
                  </p>
                </div>
                ...
                <div class="space-y-3">
                  ...
                  >
                    <div
                      class="w-6 h-6 rounded bg-tertiary-container/20 flex items-center justify-center"
                    >
                      <lucide-icon
                        [img]="EyeIcon"
                  ...
                  <p class="text-sm pl-8">
                    Cloud hosting providers, analytics providers, customer
                    support tools, and security monitoring services that help us
                ...
                <div class="space-y-3">
                  ...
                  >
                    <div
                      class="w-6 h-6 rounded bg-error-container/50 flex items-center justify-center"
                    >
                      <lucide-icon
                        [img]="LockIcon"
                  ...
                  <p class="text-sm pl-8">
                    We may disclose information when required by law, by court
                    order, upon regulatory request, or during a fraud
                    investigation.
                  </p>
                </div>
              </div>
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                <p>
                  Solexpay implements comprehensive security measures including:
                </p>

                <div class="grid sm:grid-cols-2 gap-4">
                  <div
                    class="flex items-center gap-3 p-4 bg-tertiary-container/10 rounded-lg border border-tertiary-container/20"
                  >
                    <lucide-icon
                      [img]="LockIcon"
                      class="w-5 h-5 text-tertiary"
                  ...
                  >
                    ...
                    ></lucide-icon>
                    <span class="text-sm font-medium text-on-surface"
                      >Monitoring systems</span
                    >
                  </div>
                </div>

                <div
                  class="bg-error-container/30 rounded-lg p-4 border-l-4 border-error"
                >
                  <p class="text-sm text-on-error-container">
                    <span class="font-semibold">Important:</span> Despite these
                    safeguards, no system is completely secure. We continuously
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                ...
                <div class="bg-surface-container rounded-lg p-4">
                  <p class="text-sm">
                    We may retain certain data even after account closure where
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                ...
                <div
                  class="bg-primary-container/10 rounded-lg p-4 border border-primary-container/20"
                >
                  <h4
                    class="font-semibold text-on-surface mb-2 flex items-center gap-2"
                  >
                    <lucide-icon
                      [img]="DatabaseIcon"
                      class="w-4 h-4 text-primary"
                ...
                >
                  <p class="text-sm text-on-surface-variant">
                    <span class="font-semibold text-on-surface">Note:</span>
                    Some requests may be limited by legal obligations (for
                    example, we cannot delete transaction data that we are
                    required to keep for 5 years).
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                ...
                <div class="bg-surface-container rounded-lg p-4">
                  <p class="text-sm">
                    You may disable cookies or similar tracking through your
                    device settings or app permissions, but some features of the
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                <p>
                  Solexpay may contain links or integrations with third‑party
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                <div
                  class="bg-error-container/30 rounded-lg p-4 border border-error-container/50"
                >
                  <p class="text-sm text-on-error-container">
                    <span class="font-semibold">Important:</span> Solexpay
                    services are not intended for individuals under 18 years of
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                ...
                <p>
                  Continued use of the platform after notice of material changes
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                <p>
                  ...
                  your country where required for service delivery.
                </p>
                <div class="bg-surface-container rounded-lg p-4">
                  <p class="text-sm">
            ...
            <!-- Related Documents -->
            <div
              class="bg-secondary-container/10 rounded-2xl p-8 border border-secondary-container/20"
            >
              <div class="text-center space-y-4">
                ...
                <p class="text-on-surface-variant leading-relaxed">
                  Make sure to also review our Terms of Service for complete

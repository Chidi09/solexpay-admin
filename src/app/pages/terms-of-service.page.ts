...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-surface">
      ...
      <!-- Hero Section -->
      <section
        class="pt-32 pb-12 bg-gradient-to-b from-primary-fixed/30 to-surface"
      >
        <div class="max-w-4xl mx-auto px-6">
          ...
          <div class="space-y-4">
            <div
              class="inline-flex items-center gap-2 px-4 py-2 bg-primary-container/20 rounded-full text-sm font-medium text-primary"
            >
            ...
            >
              These Terms of Service govern your use of the Solexpay platform,
              including our mobile application, website, and related services.
            </p>
      ...
      <section class="py-8">
        <div class="max-w-4xl mx-auto px-6">
          <div
            class="bg-secondary-fixed/50 border-l-4 border-secondary rounded-r-xl p-6"
          >
            <div class="flex items-start gap-4">
              ...
              ></lucide-icon>
              <div class="space-y-2">
                <h3 class="font-semibold text-on-surface font-display">
                  Notice
                </h3>
                <p class="text-sm text-on-surface-variant leading-relaxed">
                  These Terms of Service govern your use of the Solexpay
                  platform, including our mobile application, website, and
                  related services.
                </p>
                <p class="text-sm text-on-surface-variant leading-relaxed">
                  By accessing or using Solexpay, you agree to be bound by these
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                <div class="space-y-3">
                  ...
                  <p>
                    Solexpay provides financial technology services that enable
                    users to hold wallet balances, send and receive money,
                    create virtual payment cards, and make payments.
                  </p>
                  <p>
                    Solexpay is not a bank. Banking and card services are
                    provided through licensed partner financial institutions
                    where applicable.
                  </p>
                </div>
                  ...
                  <ul class="space-y-2 list-disc list-inside">
                    <li>
                      <span class="font-medium text-on-surface"
                        >"Solexpay", "we", "us", or "our"</span
                      >
                      refers to Solexpay.
                    </li>
                    <li>
                      <span class="font-medium text-on-surface">"User"</span>
                      refers to any individual accessing the Solexpay platform.
                    </li>
                    <li>
                      <span class="font-medium text-on-surface">"Account"</span>
                      refers to your Solexpay wallet and related services.
                    </li>
                    <li>
                      <span class="font-medium text-on-surface"
                        >"Services"</span
                      >
                      refer to all features provided by Solexpay including
                      wallets, transfers, and virtual cards.
                    </li>
                    <li>
                      <span class="font-medium text-on-surface"
                        >"Wallet Balance"</span
                      >
                      refers to the electronic value held in your Solexpay
                      account, which is not a bank deposit.
                    </li>
                  </ul>
                </div>
                ...
                <div class="space-y-3">
                  ...
                  <p class="text-sm bg-surface-container rounded-lg p-4">
                    Services may be modified or updated at any time.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                <div class="space-y-3">
                  ...
                  <p class="text-sm bg-error-container/50 rounded-lg p-4 mt-3">
                    <span class="font-medium text-on-error-container"
                      >Important:</span
                    >
                ...
                <div class="space-y-3">
                  ...
                  <p class="text-sm bg-surface-container rounded-lg p-4 mt-3">
                    ...
                    Wallet balances are not bank deposits. Funds may be held
                ...
                <div class="space-y-3">
                  ...
                  <p>
                    Solexpay allows users to create virtual payment cards for
                    online transactions.
                  </p>
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                <div class="space-y-3">
                  ...
                  <div class="grid sm:grid-cols-2 gap-3 mt-3">
                    ...
                    <div class="bg-error-container/30 rounded-lg p-3 text-sm">
                      <span class="font-medium text-on-error-container"
                        >Sanctioned merchants</span
                      >
                    </div>
                    <div class="bg-error-container/30 rounded-lg p-3 text-sm">
                      <span class="font-medium text-on-error-container"
                        >Dark web services</span
                      >
                    </div>
                    <div class="bg-error-container/30 rounded-lg p-3 text-sm">
                      <span class="font-medium text-on-error-container"
                        >Unauthorized reselling</span
                      >
                    </div>
                    <div class="bg-error-container/30 rounded-lg p-3 text-sm">
                      <span class="font-medium text-on-error-container"
                  ...
                  <p class="text-sm mt-3">
                    Solexpay may decline such transactions automatically.
                  </p>
                </div>
                ...
                <div class="space-y-3">
                  ...
                  <p class="text-sm bg-surface-container rounded-lg p-4 mt-3">
                    All fees are displayed within the platform. Fees may change
                    at any time.
                  </p>
                </div>
                ...
                <div class="space-y-3">
                  ...
                  <p class="text-sm mt-3">
                    All funding is subject to verification.
                  </p>
                </div>
                ...
                <div class="space-y-3">
                  ...
                  <p class="text-sm bg-error-container/50 rounded-lg p-4 mt-3">
                    <span class="font-medium text-on-error-container"
                      >Important:</span
                    >
                    Solexpay is not responsible for wrong transfers made by
                    users.
                  </p>
                </div>
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                <div class="space-y-3">
                  ...
                  <p class="text-sm mt-3">
                    Funds may be held during investigation.
                  </p>
                </div>

                <div class="space-y-3">
                  <h3 class="font-semibold text-on-surface">
                    1.14 Account Closure and Deletion
                  </h3>
                  <p>
                    You may close or delete your Solexpay account at any time if
                  ...
                  <ul class="space-y-2 list-disc list-inside">
                    <li>
                      Use the account deletion option within the app, where
                      available
                    </li>
                    <li>
                      Contact Solexpay support through the official support
                      channels
                    </li>
                  </ul>
                  <p class="mt-3">
                    Upon receiving a valid deletion request, Solexpay will:
                  </p>
                  <ul class="space-y-2 list-disc list-inside">
                  ...
                  <p class="mt-3">
                    Solexpay may retain certain information after account
                    closure where required for:
                  </p>
                  <ul class="space-y-2 list-disc list-inside">
                  ...
                  <p class="text-sm bg-error-container/50 rounded-lg p-4 mt-3">
                    <span class="font-medium text-on-error-container"
                      >Note:</span
                    >
                    Account deletion is permanent and cannot be reversed once
                    completed.
                  </p>
                </div>
                ...
                <div class="space-y-3">
                  ...
                  <p class="mt-3">
                    Refund timelines vary and may take several business days.
                  </p>
                ...
                <div class="space-y-3">
                  ...
                  <p>
                    Solexpay is not responsible for merchant failures, payment
                    network downtime, card provider issues, exchange rate
                    changes, user mistakes, or third‑party services.
                  </p>
                  <p class="mt-3">
                    Nothing in this section limits our liability for fraud,
                    death, personal injury, or breach of applicable financial
                    regulations.
                  </p>
                  <p class="text-sm bg-surface-container rounded-lg p-4 mt-3">
                    Use of Solexpay is at your own risk, subject to applicable
                    law.
                  </p>
                </div>
              </div>
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-6 text-on-surface-variant leading-relaxed">
                <div class="space-y-3">
                  ...
                  <p>
                    Your use of Solexpay is also governed by our Privacy Policy.
                  </p>
                  <p>
                    We collect and process data in accordance with applicable
                    laws.
                  </p>
                  <p class="text-sm mt-3">
                    <a
                ...
                <div class="space-y-3">
                  ...
                  <p class="mt-3">
                    Before filing any legal claim, you must first submit a
                    written complaint to
                    <a
                      href="mailto:support@solexpay.com.ng"
                      class="text-primary hover:underline"
                      >support&#64;solexpay.com.ng</a
                    >. We will respond within 14 days.
                  </p>
                  <p class="mt-3">
                    Any disputes not resolved shall be brought exclusively in
                ...
                <div class="space-y-3">
                  ...
                  <p>
                    ...
                    or visit
                    <a
                      href="https://www.solexpay.com.ng"
                      target="_blank"
                      rel="noopener"
                      class="text-primary hover:underline"
                      >www.solexpay.com.ng</a
                    >.
                  </p>
                </div>
              </div>
            ...
            >
              <div class="text-center space-y-4">
                ...
                <p class="text-on-surface-variant leading-relaxed">
                  By using Solexpay, you acknowledge that you have read,
